...
function ContactUs() {
  ...
  const validatePassword = () => {
    // Password should be 8-12 characters long, contain at least one letter, one number, and no special characters
    const passwordRegex = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,12}$/;
    if (!passwordRegex.test(password)) {
      setErrorMessage(
        "Password must be 8-12 characters long, contain both letters and numbers, and no special characters."
      );
      return false;
    }
    return true;
        ...
        <div className="col-md-6 shadow">
          ...
          <div className="card">
            <div className="card-body">
              <p className="shadow">
                VidhyaDhan-Foundation, 42-32/1, Near Jagathgiri busstop, Kukatpally,
